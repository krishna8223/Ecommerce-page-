    ...
    return (
        <>
            ...
            <section onSubmit={submit}>
                <h2 className='sm:mt-28 mt-[2.5rem] text-center text-5xl'>Login Here</h2>
                <div className="wrapper my-[2.5rem] mx-auto w-full md:w-[60%] h-full">
                    <form action="" required className=' shadow-lg  w-[85%] sm:w-fit  mx-auto max-w-[455px]  sm:px-20 px-4 py-28 bg-slate-100 rounded-2xl flex flex-col gap-12'>
