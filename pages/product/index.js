...
function Slug({data}) {
  ...
  return (
    ...
    <section className='product-page-section'>
      <div className="product-page w-3/5 mx-auto py-20">
        ...
        <Image
          ...
          <div className="product-page__details">
            <h2 className="product-page__title text-8xl">{title}</h2>
            ...
            <button className="product-page__add text-3xl flex justify-center items-center hover:bg-slate-900 cursor-pointer duration-300 mt-12 bg-slate-800 w-fit p-4 text-white rounded-lg">Add to cart</button>
          </div>
      </div>
    </section>
