...
export default function SignUp() {
  ...
  return (
      ...
      <section onSubmit={submit}>
        <h2 className='sm:mt-28 mt-[2.5rem]  text-center text-5xl'>SignUp Here</h2>
        <div className="wrappe my-[2.5rem] mx-auto w-full md:w-[60%] h-full">
            <form action=""  className=' shadow-lg w-[85%] max-w-[455px] sm:w-fit mx-auto sm:px-20 px-4 py-28 bg-slate-100 rounded-2xl flex flex-col gap-12'>
